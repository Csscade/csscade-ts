export const MentionsLegalesPage = () => {
  return (
    ...
    >
      ...
      >
        <h1 style={{ marginBottom: "2rem", fontSize: "var(--fs-h1)" }}>
          Mentions Légales
        </h1>

        <section style={{ marginBottom: "2rem" }}>
          <h2 style={{ fontSize: "var(--fs-h2)", marginBottom: "1rem" }}>
            1. Édition du site
          </h2>
          <p>
            ...
            utilisateurs du site internet <strong>csscade.fr</strong> l'identité
        ...
        <section style={{ marginBottom: "2rem" }}>
          ...
          <p>
            Csscade ne pourra être tenu pour responsable des dommages directs et
