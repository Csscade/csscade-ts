    ...
    <main id="maincontent" className="about-page">
      <div className="about-page__container">
        ...
        <section className="about-page__section">
          ...
          <p>
            Notre mission est de partager des connaissances, des astuces et des
            retours d'expérience. Que vous soyez débutant·e ou expert·e, Csscade
            se veut être une source d'inspiration et d'apprentissage continu.
          </p>
        </section>
        ...
        <section className="about-page__section">
          ...
          <p>
            ...
            <strong>accessibilité</strong> (respect des normes WCAG 2.2 et RGAA
            4.1) dans chaque contribution.
          </p>
